...
import kotlinx.android.synthetic.main.item_user_map.*
import java.io.*
...
//                listItem.setBackgroundColor(resources.getColor(R.color.highlight))
//                tvMapTitle.setTextColor(resources.getColor(R.color.background))
//                tvNumPlaces.setTextColor(resources.getColor(R.color.background))
//                ivChevron.setColorFilter(resources.getColor(R.color.background));
    ...
    private fun showAlertDialog() {
        ...
        dialog.getButton(DialogInterface.BUTTON_POSITIVE).setOnClickListener {
            val title =
                mapFormView.findViewById<EditText>(R.id.etNewMapTitle).text.toString().trim()
            if (title.isEmpty()) {
